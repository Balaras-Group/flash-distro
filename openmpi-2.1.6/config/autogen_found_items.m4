...
dnl
dnl Generated by mpiteam at Wed Nov 28 16:34:30 2018
dnl on ip-172-31-9-163.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_opal_common_m4_config_component_list], [cuda, sm, ugni, verbs, libfabric, verbs_usnic])
...
m4_define([mca_opal_btl_m4_config_component_list], [openib, vader, tcp, portals4, sm, usnic, ugni, smcuda, scif])
...
m4_define([mca_opal_if_m4_config_component_list], [bsdx_ipv6, solaris_ipv6, bsdx_ipv4, posix_ipv4, linux_ipv6])
...
m4_define([mca_opal_pmix_m4_config_component_list], [s1, cray, pmix112, s2, external])
...
m4_define([mca_opal_timer_m4_config_component_list], [solaris, altix, darwin, linux])
...
m4_define([mca_orte_errmgr_no_config_component_list], [default_tool, default_orted, default_hnp, default_app])

dnl Components in the orte / ess framework
m4_define([mca_orte_ess_m4_config_component_list], [lsf, slurm, tm, alps])
m4_define([mca_orte_ess_no_config_component_list], [singleton, pmi, env, hnp, tool])
...
m4_define([mca_orte_iof_no_config_component_list], [mr_hnp, orted, hnp, tool, mr_orted])
...
m4_define([mca_orte_odls_m4_config_component_list], [default, alps])
m4_define([mca_orte_odls_no_config_component_list], [])

dnl Components in the orte / oob framework
m4_define([mca_orte_oob_m4_config_component_list], [ud, tcp, alps, usock])
m4_define([mca_orte_oob_no_config_component_list], [])

dnl Components in the orte / plm framework
m4_define([mca_orte_plm_m4_config_component_list], [lsf, isolated, slurm, tm, rsh, alps])
m4_define([mca_orte_plm_no_config_component_list], [])

dnl Components in the orte / ras framework
m4_define([mca_orte_ras_m4_config_component_list], [lsf, loadleveler, slurm, tm, alps, gridengine])
...
m4_define([mca_orte_rmaps_no_config_component_list], [round_robin, resilient, mindist, rank_file, ppr, seq, staged])
...
m4_define([mca_orte_routed_no_config_component_list], [radix, debruijn, binomial, direct])
...
m4_define([mca_orte_state_no_config_component_list], [novm, orted, app, dvm, hnp, tool, staged_hnp, staged_orted])
...
m4_define([mca_ompi_coll_m4_config_component_list], [fca, cuda, portals4, hcoll])
m4_define([mca_ompi_coll_no_config_component_list], [sync, tuned, sm, basic, inter, self, libnbc])

dnl Components in the ompi / fbtl framework
m4_define([mca_ompi_fbtl_m4_config_component_list], [posix, pvfs2, plfs])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [individual, two_phase, static, dynamic, dynamic_gen2])

dnl Components in the ompi / fs framework
m4_define([mca_ompi_fs_m4_config_component_list], [pvfs2, plfs, lustre])
...
m4_define([mca_ompi_mtl_m4_config_component_list], [psm2, portals4, ofi, mxm, psm])
...
m4_define([mca_ompi_pml_m4_config_component_list], [yalla, v, ob1, ucx])
